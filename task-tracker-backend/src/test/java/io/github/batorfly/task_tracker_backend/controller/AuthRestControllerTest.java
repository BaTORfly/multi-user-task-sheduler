...
import io.github.batorfly.task_tracker_backend.api.controller.auth.AuthRestController;
...
public class AuthRestControllerTest {
    ...
    class SignUpTests {
        ...
        @Test
        @SneakyThrows
        void signup_shouldResponseWithAccessTokenAndOkStatusCode() {

            // given
            var request = new SignupForm(TEST_FIRST_NAME, TEST_LAST_NAME, TEST_EMAIL, TEST_PASSWORD);
            var requestBuilder =
                    post(SIGN_UP_URL)
